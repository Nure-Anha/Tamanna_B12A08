...
const Banner = () => {
    return (
        ...
        {/* Banner Title , Subtitle */}
            <h3 className='pt-20 font-bold text-[#001931] text-7xl text-center mb-6'>We Build <br /> <span className='bg-linear-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent font-extrabold'>Productive</span> Apps</h3>
        ...
        <div className="bg-linear-to-r from-[#632EE3] to-[#9F62F2] text-white">
            <h3 className='text-center text-5xl font-semibold pb-10 pt-20'>Trusted by Millions, Built for You</h3>

            <div className='flex flex-col md:flex-row justify-center items-center pb-20 '>
                
                <div className='mt-5 mb-20 md:mb-0 md:mt-0'>
                ...
                <div className='md:ml-40 mb-20 md:mb-0'>
